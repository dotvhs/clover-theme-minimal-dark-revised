# Flat, Dark & Minimal Clover Theme (with labels)
...
[There is also version without labels](https://github.com/dotvhs/clover-theme-minimal-dark-revised/)

![Screenshot of the theme](https://i.imgur.com/trGu9ru.png)
